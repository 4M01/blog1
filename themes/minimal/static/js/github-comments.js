...
function DoGithubComments(comment_id, page_id) {
    ...
    var url = "https://github.com/4M01/blog/issues/" + comment_id;
    ...
    $(document).ready(function () {
        ...
        $.ajax(api_comments_url, {
            ...
            success: function (comments, textStatus, jqXHR) {
                ...
                if (page_id == 1)
                    $("#gh-comments-list").append("<a href='" + url + "#new_comment_field' rel='nofollow'  target='_blank' class='postCommentBtn'>Post a comment on Github</a>");
